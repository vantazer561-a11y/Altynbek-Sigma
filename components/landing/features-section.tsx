...
const features = [
  {
    number: "01",
    title: "Деплоил силой взгляда",
    description: "Говорят, Altynbek не пользовался CI/CD. Он просто смотрел на сервер своим квадратным лицом — и код оказывался в проде. Шымкент не знал даунтайма.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Писал нейросети на бумаге",
    description: "Ему не нужен был GPU. Сигма-энергия позволяла ему обучать модели в уме, пока он пил чай на Аль-Фараби. Результат всегда сходился с первой эпохи.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Code review одним кивком",
    description: "Когда Altynbek кивал квадратной головой — пулл-реквест мёржился сам. Когда хмурился — баги исчезали из истории, будто их и не было.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Файрвол из чистой харизмы",
    description: "Ни один хакер не пробил оборону Шымкента, пока за ним стоял Altynbek. Его взгляд был SOC 2, ISO и сигма-протоколом в одном лице.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            То, что умел Altynbek.
            <br />
            <span className="text-muted-foreground">И не умел больше никто.</span>
          </h2>
        </div>
