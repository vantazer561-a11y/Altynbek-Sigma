...
const words = ["богом", "легендой", "сигмой", "мифом"];
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="hidden lg:block absolute right-0 lg:right-12 top-1/2 -translate-y-1/2 w-[460px] h-[580px] opacity-90 pointer-events-none">
        ...
        />
        <span className="absolute bottom-4 left-4 font-mono text-[10px] tracking-widest text-muted-foreground">
          ALTYNBEK SIGMA · ~ ШЫМКЕНТ
        </span>
      </div>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground">
            ...
            Легенда Шымкента · с незапамятных времён
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block">Был такой сигма,</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          ...
          >
            Его звали <span className="text-foreground font-medium">Altynbek Sigma</span>. Бог в IT 
            с квадратным лицом, как у Моргенштерна. Говорят, его коммиты до сих пор 
            держат прод всего Шымкента.
          </p>
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "0 багов", label: "за всю карьеру", company: "ШЫМКЕНТ" },
                { value: "100%", label: "аптайм прода", company: "ЛЕГЕНДА" },
                { value: "квадрат", label: "форма лица", company: "МОРГЕНШТЕРН" },
                { value: "∞", label: "сигма-энергии", company: "БОГ В IT" },
              ].map((stat) => (
